...
var DropzoneArea = function (_Component) {
    ...
    createClass(DropzoneArea, [{
            ...
            if (this.state.fileObjects.length + files.length > this.props.filesLimit) {
                ...
                files.forEach(function (file) {
                    ...
                    reader.onload = function (event) {
                        _this.setState({
                            fileObjects: [{ file: file, data: event.target.result }]
                        }, function () {
      ...
      value: function componentWillReceiveProps(nextProps) {
        console.log(' ----   level 2 nextProps      -----',nextProps)
    ...
    key: 'CsvRejected',
    value: function CsvRejected(error) {
        this.setState({
          openSnackBar: true,
...
var DropzoneDialog = function (_React$Component) {
    ...
    createClass(DropzoneDialog, [{
      ...
      key: 'componentWillReceiveProps',
      value: function componentWillReceiveProps(nextProps) {
          if(nextProps.reset && this.state.files.length > 0){
            this.setState({ files: [] });
          }
      }
    },{
